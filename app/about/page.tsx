...
const About = () => {
    return (
        <div className="flex w-full h-screen overflow-scroll bg-[#FFFFFF] flex-wrap">
            <Navbar />
            <div className="flex w-[100%] xl:w-[50%] text-center mt-[100px] pt-[5%] pr-[10%] xl:pr-[5%] pl-[10%] font-semibold text-4xl justify-center xl:justify-end">
                <Image src={'/about1.jpeg'} width={0} height={0} alt="" sizes="100%" style={{ maxHeight: '800px', width: '80%', objectFit: 'cover', display: 'flex' }} />
            </div>
            <div className="flex w-[100%] xl:w-[50%] text-center xl:text-left mb-[100px] xl:mt-[100px] px-[5%] pt-[5%] font-semibold xl:text-2xl text-xl 2xl:text-3xl">
