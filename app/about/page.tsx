...
const About = () => {
    return (
        <div className="flex w-full h-screen overflow-scroll bg-[#FFFFFF] flex-wrap">
            <Navbar />
            <div className="flex w-[100%] xl:w-[50%] text-center xl:text-right mt-[100px] pt-[10%] pr-[10%] xl:pr-[5%] pl-[10%] font-semibold xl:text-2xl text-xl 2xl:text-3xl">
            ...
            <div className="flex w-[100%] xl:w-[50%] text-center xl:mt-[100px] py-[10%] px-[25px] font-semibold text-4xl justify-center xl:justify-normal">
                <Image src={'/about1.jpeg'} width={0} height={0} alt="" sizes="100%" style={{ width: '80%', height: '800px', objectFit: 'cover', display: 'flex' }} />
            </div>
        </div>
    )
}
