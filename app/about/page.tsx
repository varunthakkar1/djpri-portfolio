...
const About = () => {
    return (
        <div className="flex w-full h-screen overflow-scroll bg-[#FFFFFF] flex-wrap">
            <Navbar />
            <div className="flex w-[100%] xl:w-[50%] text-center xl:text-right mt-[100px] pt-[100px] pr-[10%] pl-[10%] font-semibold xl:text-2xl text-xl 2xl:text-4xl">
            ...
            <div className="flex w-[100%] xl:w-[50%] text-center xl:mt-[100px] py-[100px] px-[25px] font-semibold text-4xl justify-center xl:justify-normal">
